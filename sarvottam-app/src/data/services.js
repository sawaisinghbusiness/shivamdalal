...
export const EMERGENCY_SERVICES = [
  { id: 'electrician', name: 'Electrician', icon: 'plug',    color: '#E5484D', desc: 'Quick electrical repair at your doorstep',
    karigar: { name: 'Ramesh Kumar', initial: 'R', rating: 4.8, jobs: 320, eta: 8 },  service: 400 },
  { id: 'plumber',     name: 'Plumber',     icon: 'droplet', color: '#0B6BBF', desc: 'Leakage, pipe fitting, bathroom & kitchen repair',
    karigar: { name: 'Suresh Mali', initial: 'S', rating: 4.7, jobs: 210, eta: 10 },  service: 350 },
  { id: 'carpenter',   name: 'Carpenter',   icon: 'hammer',  color: '#A05A0B', desc: 'Door, hinge fix, lock replacement & woodwork',
    karigar: { name: 'Mahesh Suthar', initial: 'M', rating: 4.9, jobs: 415, eta: 12 }, service: 450 },
  { id: 'ac',          name: 'AC Repair',   icon: 'fan',     color: '#0891B2', desc: 'Installation, repair, servicing & gas refill',
    karigar: { name: 'Dinesh Jain', initial: 'D', rating: 4.6, jobs: 180, eta: 15 },  service: 600 },
  { id: 'painter',     name: 'Painter',     icon: 'roller',  color: '#7C3AED', desc: 'Wall touch-up, waterproofing & full home painting',
